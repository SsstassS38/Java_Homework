...
public class Example1 {
    ...
    static void WriteAnswerToFile(String data, String path) {
        ...
        try {
            FileHandler fileHandler = new FileHandler("Homework/Homework2/log.txt");
